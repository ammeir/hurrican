...
// für Funken, Rauchwolken, Patronenh�lsen usw.
//
...
void PartikelClass::CreatePartikel(float x, float y, int Art, PlayerClass *pParent)
{
    ...
    AnimPhase   = 0;
    AnimCount   = 0.0f;
    AnimEnde    = 0;		// Standardm�ssig von einem nicht animierten Partikel ausgehen
    AnimSpeed   = 0.0f;
    BounceWalls = false;
    ...
    if (Art < ADDITIV_GRENZE)
        switch (Art)
        {
        case BULLET :	// Leere Patronenh�lse
        {
            //DKS - now redundant:
        ...
        case BULLET_SKELETOR :	// Leere Patronenh�lse vom Skeletor
        {
            //DKS - now redundant:
            //red	= 255; green = 255; blue = 255; alpha = 255;
        ...
        case SMOKE2:			// Rauch bei zB Lava böllen
        {
            //DKS - now redundant:
            //red	= 255; green = 255; blue = 255;
            alpha = 128;
        ...
        case SNOWFLUSH:		// SchneeGestüber und Wasserfall Rauch
        {
            //DKS - now redundant:
            //red	= 255; green = 255; blue = 255; alpha = 255;
        ...
        case ROCKETSMOKEGREEN :	// und das selbe nochmal in gr�n :D
        {
            //DKS - now redundant:
            //red	= 255; green = 255; blue = 255;
            alpha = 150;
        ...
        case BUBBLE :		// Luftblöschen im Wasser
        {
            //DKS - now redundant:
            //red	= 255; green = 255; blue = 255; alpha = 255;
            xSpeed =  0.0f;
        ...
        {
            // Schild farbliche an die aktuelle St�rke anpassen
...
// Wird dadurch im Schnitt hoffentlich doppelt so schnell ;)
    ...
    if (PartikelArt < ADDITIV_GRENZE)
        ...
        case SPIDERPARTS:				// Spinnenstücke auf dem Fliessband
        {
            ...
            // an der Wand abprallen oder aufh�ren und verschwinden
        ...
        case PIRANHATEILE2 :					// Teile eines kaputten Riesen Piranhas
        {
            ...
            if (ySpeed == 0.0f)				// an der Oberfl�che langsam ausfaden lassen
            ...
            // An der Wand Seitw�rtsbewegung einstellen
            ...
            // An der Decke oder der Oberfl�che Aufw�rtsbewegung einstellen
        ...
        case SPAWNDROP :				// Wassertropfen aus dem Spawner
        {
			...
			// Make a check that the y pixel position is out of screen.
...
//				Projectiles.PushProjectile(xPos - 30, yPos, FLAMEWALL);
        ...
        case WATERFUNKE:
        {
            // In Fl�ssigkeit? Dann gleich verschwinden
        ...
        case WASSERTROPFEN:					// Verschindet an der Wasseroberfl�che
        {
            Lebensdauer -= 16.0f SYNC;	// langsam ausfaden lassen
        ...
        case BUBBLE:						// Zerplatzt an der Wasseroberfl�che
        {
            // Richtung umdrehen ?
            if ((xSpeed < -AnimCount &&
                    xAcc < 0.0f) ||
...
bool PartikelClass::Render(void)
{
    ...
    else if (PartikelArt == WASSER_SPRITZER ||
             PartikelArt == WASSER_SPRITZER2)
    {
        int h, b;
