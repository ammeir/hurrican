...
// --------------------------------------------------------------------------------------
//
// Projektile (Sch�sse) für Hurrican
//
...
// Sch�sse, die mit normalem Alpha gerendert werden
...
#define	BOUNCESHOT2_LONG		7						// BounceShot des Spielers Stufe mittel, h�lt l�nger =)
#define	BOUNCESHOT3_LONG		8						// BounceShot des Spielers Stufe mittel, h�lt l�nger =)
...
#define LAFASSSHOT				44						// Das Fass, wenn es runterf�llt
#define FLUGLASER				45
...
// Sch�sse, die additiv gerendert werden
...
public:
    ...
    bool				CheckBlock;					// �berhaupt Kollision mit Wand checken?
    bool				HasGlow;					// Leuchten?
    bool				ExplodeOnImpact;			// Sch�sse, die durch Objekte durchgehen
...
// --------------------------------------------------------------------------------------
// Projectile Klasse, Linked List, die alle Sch�sse beinhaltet
// --------------------------------------------------------------------------------------

class ProjectileListClass
{
private:
    int						NumProjectiles;			// aktuelle Zahl der Sch�sse
...
public:
    ...
    bool PushProjectile(float x, float y, int Art, PlayerClass* pTemp = NULL); 	// Schuss "Art" hinzuf�gen
    bool PushBlitzBeam (int Size, float Richtung, PlayerClass* pSource);	// BlitzBeam hinzuf�gen (in verschiedenen Größen und Richtungen möglich)
