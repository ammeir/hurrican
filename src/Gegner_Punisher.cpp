...
// Der Punisher verfolgt den Spieler st�ndig, daFür recht langsam.
// Er ist nahezu unbesiegbar, und bei Ber�hrung verliert der Spieler ein Leben und alle
// Waffen-Powerups, erh�lt daFür aber wieder volle Zeit
// Besiegt der Spieler den Punisher, so erh�lt er daFür ein Extraleben, voll Zeit
...
void GegnerPunisher::DoDraw(void)
{
    ...
    case GEGNER_SPECIAL:
    {
		...
		DirectGraphics.SetTexture(pGegnerGrafix[GegnerArt]->itsTexIdx);
