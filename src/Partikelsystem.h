...
#define	EXPLOSION_GREEN 		5						// grüne mittelgro�e Explosion
...
#define SPIDERPARTS				59						// Spinnenst�cke auf dem Fliessband
...
#define	BULLET_SKELETOR			68						// Patronenh�lse vom letzten Endboss
...
#define WASSERTROPFEN2			107						// Spritzer beim in die S�ure eintreten
#define BUBBLE					108						// Luftblöschen unter Wasser
...
#define SNOWFLUSH				127						// Schneegestüber
...
#define SHOTFLARE2				151						// Leuchten bei Schuss-Explosion gr�n
...
#define EXPLOSION_REGULAR		157						// Kleinere Explosion in Gelb, die immer gleich abl�uft
...
#define EXPLOSION_TRACE_END		163						// In der Größe ver�nderbar
...
public:
    ...
    PartikelClass		*pNext;						// Zeiger auf den n�chsten   Partikel
...
public:
    ...
    bool PushPartikel(float x, float y, int Art,
                      PlayerClass* pParent = NULL);	// Partikel "Art" hinzuf�gen
