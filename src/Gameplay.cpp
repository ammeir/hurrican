...
void ShowGameOver(void)
{
    ...
    // GameOver vorbei ?
    // Dann sch�n alle löschen und auf ein neues Spiel vorbereiten
...
{
    // Werte für das Screenwackeln setzen, um den Screen leicht zu sch�tteln
...
void CreateDefaultControlsConfig(int player)
{
    ...
    if (player == 0) {
...
#elif defined(PSVITA)
        Player[0].AktionJoystick [AKTION_LINKS]			= VITA_PAD_LEFT;
        Player[0].AktionJoystick [AKTION_RECHTS]		= VITA_PAD_RIGHT;
        Player[0].AktionJoystick [AKTION_DUCKEN]		= VITA_PAD_DOWN;
        Player[0].AktionJoystick [AKTION_OBEN]			= VITA_PAD_UP;
        Player[0].AktionJoystick [AKTION_UNTEN]			= VITA_PAD_DOWN;
        Player[0].AktionJoystick [AKTION_JUMP]			= VITA_PAD_CROSS;
        Player[0].AktionJoystick [AKTION_SHOOT]			= VITA_PAD_SQUARE;
        Player[0].AktionJoystick [AKTION_BLITZ]			= VITA_PAD_TRIANGLE;
        Player[0].AktionJoystick [AKTION_POWERLINE]		= VITA_PAD_CIRCLE;
        Player[0].AktionJoystick [AKTION_GRANATE]		= VITA_PAD_RTRIGGER;
        Player[0].AktionJoystick [AKTION_SMARTBOMB]		= VITA_PAD_LTRIGGER;
        ...
        Player[0].AktionJoystick [AKTION_WAFFEN_CYCLE]	= VITA_PAD_SELECT; 
#else
...
#ifdef PSVITA
        Player[1].AktionJoystick [AKTION_LINKS]			= VITA_PAD_LEFT;
        Player[1].AktionJoystick [AKTION_RECHTS]		= VITA_PAD_RIGHT;
        Player[1].AktionJoystick [AKTION_DUCKEN]		= VITA_PAD_DOWN;
        Player[1].AktionJoystick [AKTION_OBEN]			= VITA_PAD_UP;
        Player[1].AktionJoystick [AKTION_UNTEN]			= VITA_PAD_DOWN;
        Player[1].AktionJoystick [AKTION_JUMP]			= VITA_PAD_CROSS;
        Player[1].AktionJoystick [AKTION_SHOOT]			= VITA_PAD_SQUARE;
        Player[1].AktionJoystick [AKTION_BLITZ]			= VITA_PAD_TRIANGLE;
        Player[1].AktionJoystick [AKTION_POWERLINE]		= VITA_PAD_CIRCLE;
        Player[1].AktionJoystick [AKTION_GRANATE]		= VITA_PAD_RTRIGGER;
        Player[1].AktionJoystick [AKTION_SMARTBOMB]		= VITA_PAD_LTRIGGER;
        ...
        Player[1].AktionJoystick [AKTION_WAFFEN_CYCLE]	= VITA_PAD_SELECT; 
#else
