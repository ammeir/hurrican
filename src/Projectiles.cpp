...
void ProjectileClass::Run(void)
{
    ...
    // Auf Kollision mit dem Level Testen (nur bei Bounce-f�higen Schüssen)
    if(BounceWalls == true)
    {
        int DoDamage = 0;
    ...
    case FIREBALL_BIG:
    {
        ...
        if (AnimCount < 0.0f)
        {
			...
			int xPos_ = xPos + 10;
			int yPos_ = yPos + 10;
            PartikelSystem.PushPartikel(xPos_ + rand()%20, yPos_ + rand()%20, FIREBALL_SMOKE);
			PartikelSystem.PushPartikel(xPos_ + rand()%20, yPos_ + rand()%20, FIREBALL_SMOKE);
			PartikelSystem.PushPartikel(xPos_ + rand()%20, yPos_ + rand()%20, FIREBALL_SMOKE);
			//PartikelSystem.PushPartikel(xPos_ + rand()%20, yPos_ + rand()%20, FIREBALL_SMOKE);
        }
    ...
    case GOLEMSAEULE:
    {
        ...
        if (AnimCount <= 0.0f)
        {
			...
			Projectiles.PushProjectile(xPos, yPos + 5.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 10.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 15.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 20.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 25.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 30.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 35.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 40.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 45.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 50.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 55.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 60.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 65.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 70.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 75.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 80.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 85.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 90.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 95.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 100.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 105.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 110.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 115.0f, FEUERFALLE);
			Projectiles.PushProjectile(xPos, yPos + 120.0f, FEUERFALLE);
        }
    ...
    case PHARAOLASER:
    {
        ...
        for (int i=0; i < int(200 * Timer.getElapsed())+1; ++i)
            PartikelSystem.PushPartikel(xPos_, yPos_, PHARAOSMOKE);
    ...
    case ROCKETSPIDER:
    {
        ...
        for (int i=0; i < int(200 * Timer.getElapsed())+1; i++)
        {
            ...
            case 0 :
            {
                PartikelSystem.PushPartikel(xPos_, yPos_, ROCKETSMOKE);
            }
            break;

            case 4 :
            {
                PartikelSystem.PushPartikel(xPos_, yPos - 2, ROCKETSMOKE);
            }
            break;
            }
        }
    ...
    case ROCKETWERFER:
    {
...

        {
            ...
            for (int i=0; i < int(200 * Timer.getElapsed())+1; i++)
            {
                ...
                case 0 :
                {
                    PartikelSystem.PushPartikel(xPos_, yPos, ROCKETSMOKE);
                }
                break;
    ...
    case EVILBLITZ:
    {
		...
		int yPos_ = yPos + 60;
        for (int i=0; i < int(200 * Timer.getElapsed())+1; i++)
            PartikelSystem.PushPartikel(xPos_ + rand()%50, yPos_ + rand()%20, EVILFUNKE);
...
//				PartikelSystem.PushPartikel(xPos - 2, yPos - 2, ROCKETSMOKEBLUE);
    ...
    case GRENADE:
    {
        ...
        {
            AnimCount += 0.2f;//0.1f; PSVITA TWEAK
    ...
    for (int p = 0; p < NUMPLAYERS; p++)
                                ...
                                Player[p].xpos, Player[p].ypos, Player[p].CollideRect) == true)
        {
            ...
            // Schüsse, die bei Ber�hrung verschwinden
            else
            {
...
void ProjectileClass::ExplodeShot(void)
{
    ...
    case FIREBALL_BOMB:
    {
		...
		float yPos_ = yPos - 20;
        //for(i=0; i<2; i++)
        PartikelSystem.PushPartikel(xPos_, yPos_, EXPLOSIONFLARE);
		PartikelSystem.PushPartikel(xPos_, yPos_, EXPLOSIONFLARE);

		yPos_ = yPos - 5;
        //for(i=0; i<4; i++)
        PartikelSystem.PushPartikel(xPos + rand()%20 - 10, yPos_ + rand()%10, SMOKEBIG);
		PartikelSystem.PushPartikel(xPos + rand()%20 - 10, yPos_ + rand()%10, SMOKEBIG);
		PartikelSystem.PushPartikel(xPos + rand()%20 - 10, yPos_ + rand()%10, SMOKEBIG);
		PartikelSystem.PushPartikel(xPos + rand()%20 - 10, yPos_ + rand()%10, SMOKEBIG);
		...
		yPos_ = yPos + 20;
        //for (int i = 0; i < 8; i++)
        Projectiles.PushProjectile(xPos_ + rand()%30, yPos_ + rand()%30, FEUERFALLE);
		Projectiles.PushProjectile(xPos_ + rand()%30, yPos_ + rand()%30, FEUERFALLE);
		Projectiles.PushProjectile(xPos_ + rand()%30, yPos_ + rand()%30, FEUERFALLE);
		Projectiles.PushProjectile(xPos_ + rand()%30, yPos_ + rand()%30, FEUERFALLE);
		Projectiles.PushProjectile(xPos_ + rand()%30, yPos_ + rand()%30, FEUERFALLE);
    ...
    case SPREADSHOTBIG2:
    {
        ...
        for(int i=0; i<3; ++i)
            PartikelSystem.PushPartikel(_xPos, _yPos, LONGFUNKE);
    }
    break;
    ...
    case LASERSHOTBIG2:
    {
        ...
        if (xSpeed > 0.0f)
            for(int i=0; i<5; ++i)
                PartikelSystem.PushPartikel(_xPos + rand ()%70, _yPos + rand()%20, BLUE_EXPLOSION);
        else
            for(int i=0; i<5; ++i)
                PartikelSystem.PushPartikel(xPos-20 + rand ()%20, _yPos + rand()%20, BLUE_EXPLOSION);
    }
    break;
    ...
    case SPIDERSLOW:
    {
		float xPos_ = xPos - 10.0f;
		float yPos_ = yPos - 10.0f;
        //for (int i = 0; i < 10; i++)
