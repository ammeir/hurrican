...
#define SK_WACKELN	6		// Kopf wackelt auf und ab und schl�gt dabei gegen die Decke
#define SK_SPUCKEN	7		// Kopf spuckt aus der Turbine Feuerbölle
...
private:
    ...
    // Für die Bewegung mit den xto und yto Koordinaten m�ssen wir uns am Anfang merken, ob
    // wir uns jetzt rechts oder links bzw hoch oder runter bewegen, um beim Check, ob der
    // MoveTo Punkt erreicht wurde, die richtige Abfrage setzen zu k�nnen.
    //
    bool	Moving;
