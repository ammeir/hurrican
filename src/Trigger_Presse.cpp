...
void GegnerPresse::DoKI(void)
{
    ...
    case GEGNER_LAUFEN :
    {
                 ...
                 blocku & BLOCKWERT_WAND))
        {
            ...
            // Staub erzeugen
            //for (int i=0; i < 8; i++)
			float _yPos = yPos + 244;
            PartikelSystem.PushPartikel (xPos,      _yPos, SMOKE);
			PartikelSystem.PushPartikel (xPos + 10, _yPos, SMOKE);
			PartikelSystem.PushPartikel (xPos + 20, _yPos, SMOKE);
			PartikelSystem.PushPartikel (xPos + 30, _yPos, SMOKE);
			PartikelSystem.PushPartikel (xPos + 40, _yPos, SMOKE);
			PartikelSystem.PushPartikel (xPos + 50, _yPos, SMOKE);
			//PartikelSystem.PushPartikel (xPos + 60, _yPos, SMOKE);
			//PartikelSystem.PushPartikel (xPos + 70, _yPos, SMOKE);
