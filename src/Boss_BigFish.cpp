...
void GegnerBigFish::DoDraw(void)
{
    ...
    if (AlreadyDrawn == false)
    {
        ...
        if (FlossenSin > PI_mul2)
            FlossenSin = 0.0f;

        FlossenSin2 += fact SYNC;
        if (FlossenSin2 > PI_mul2)
            FlossenSin2 = 0.0f;
    }
    ...
    if (Moving == true)
        ...
        case GEGNER_SPECIAL:
        {
                    ...
                    shot == false)
            {
                ...
                //for (int i = 0; i < 9; ++i)
                    Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, -4, true);
				    Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, -3, true);
					Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, -2, true);
					Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, -1, true);
					Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, 0, true);
					Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, 1, true);
					Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, 2, true);
					Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, 3, true);
					Gegner.PushGegner(xPos + 80.0f, yPos + 90.0f, PIRANHA, 98, 4, true);
