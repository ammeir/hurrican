    	...
    	switch (Handlung)
    	{
    		...
    		case GEGNER_LAUFEN:
    		{
    			...
    			if (AnimCount < 0.0f)
    			{
    				...
    				switch (j)
    				{
    					// aus den zwei kleinen Gesch�tzen ballern?
    					//
    					case 0 :
    					{
    					...
    					// Gesch�tze einfahren und ballern
    					//
    					case 1 :
    					{
    						xKanone    = 0.0f;
...
void GegnerFlugBoss::GegnerExplode(void)
{
    ...
    /*
    	...
    	// negativen liegt, da sonst das Spiel h�ngenbleibt =)
    	//
