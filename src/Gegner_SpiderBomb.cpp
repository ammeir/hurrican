...
// Die Spinnenbombe
//
// L�uft in Richtung Spieler und explodiert an ihm
// --------------------------------------------------------------------------------------
...
// Je nach Handlung richtig verhalten
    ...
    {
        // Kein Boden mehr unter den F�ssen ? Dann runterfallen lassen
    ...
    {
        // Wieder Boden unter den F�ssen ? Dann wieder normal laufen
        if (blocku & BLOCKWERT_WAND ||
                blocku & BLOCKWERT_PLATTFORM)
        {
            Handlung  = GEGNER_LAUFEN;
