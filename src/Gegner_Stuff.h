...
#define BROCKELROCK				21						// Br�ckelnder Felsblock
...
#define LAVABALLSPAWNER			38						// Lava Ball Spawner, der Lava bölle erzeugt
...
#define JAEGER					61						// Abfangj�ger im Flugsacklevel
...
#define MITTELSPINNE			69						// Mittelgro�e Spinne beim Wuxe Spinnenangriff
...
#define SCHNEEKOPPE				79						// Schuss des Schneek�nigs
...
#define EVILHURRI				123						// B�ser Hurrican
...
#define BRUECKE					149						// H�ngebr�cke
...
#define SHOOTPLATTFORM			155						// Schwebe Plattform (durch Button aufzul�sen)
#define GLUBSCHI				156						// Glubschauge, das dem Hurri hinterherkuckt
#define GLUBSCHI2				157						// Glubschauge von der Decke
#define COLUMN					158						// Die Säule, die umfällt, und das ganze Level schr�g stellt
...
#define SWITCH					163						// Schalter (zum T�ren öffnen)
...
#define GEGNER_DREHEN					9				// Für Gesch�tzturm
