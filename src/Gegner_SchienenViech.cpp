...
{
    // tempor�re position für Gegnerwand Check (Wandcheck komplett rausgenmommen, damit er nicht in der
    ...
    if (AnimCount > AnimSpeed)			// Grenze überschritten ?
    {
        ...
        // Vorw�rts oder r�ckw�rts animieren, je nachdem, in welche Richtung das Viech gerade fährt
        //
        if (xSpeed < 0.0f)
        {
